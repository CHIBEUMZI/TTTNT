...
const Home = () => {
    ...
    const data: DataPoint[] = [
        { year: 2015, rainfall: 1980, temperature: 24.3, supply: 1500000, demand: 1850000, price: 'low' }, 
        { year: 2016, rainfall: 1920, temperature: 24.4, supply: 1600000, demand: 1900000, price: 'medium' }, 
        { year: 2017, rainfall: 2030, temperature: 24.5, supply: 1550000, demand: 1950000, price: 'low' }, 
        { year: 2018, rainfall: 1950, temperature: 24.7, supply: 1750000, demand: 1970000, price: 'low' }, 
        { year: 2019, rainfall: 1870, temperature: 24.8, supply: 1800000, demand: 1990000, price: 'medium' }, 
        { year: 2020, rainfall: 1900, temperature: 24.6, supply: 1700000, demand: 2010000, price: 'medium' }, 
        { year: 2021, rainfall: 1940, temperature: 24.9, supply: 1850000, demand: 2030000, price: 'high' }, 
        { year: 2022, rainfall: 1890, temperature: 25.1, supply: 1900000, demand: 2050000, price: 'high' }, 
        { year: 2023, rainfall: 1950, temperature: 25.0, supply: 1950000, demand: 2070000, price: 'high' }, 
    ];
    ...
    const handleSubmit = () => {
        ...
        console.log(`Dự đoán giá hồ tiêutiêu: ${prediction1}`);
        if(prediction1 === 'high') {
        ...
        <div className="flex flex-col items-center">
            <div className="assignment">
                <h1 className="font-bold py-10 text-center">
                    BÀI TẬP LỚN: ỨNG DỤNG THUẬT TOÁN HỌC MÁY DỰ ĐOÁN XU HƯỚNG GIÁ HỒ TIÊU VIỆT NAM <br />
                    <i>(sử dụng thuật toán cây quyết định)</i>
                </h1>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 mt-2">
                ...
                <br></br>
                <div className="flex flex-col">
                    <label htmlFor="cung" className='title-inputData'>Sản Lượng</label>
                    <input type="number" id="cung" ref={cungRef} />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="cau" className='title-inputData'>Nhu cầu</label>
